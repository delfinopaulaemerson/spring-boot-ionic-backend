...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.curso.springboot.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {

		return new ApiInfo("curso Spring Boot back end", "Esta API é utilizada", "Versão 1.0",
				"https://www.riniceronte.com/terms",
				new Contact("Emerson Delfino", "rinoceronte.com/user/emerson-delfino", "emersondelfino@gmail.com"),
				"Permitido para todos", "https://www.rinoceronte.com/terms", Collections.emptyList());
	}
