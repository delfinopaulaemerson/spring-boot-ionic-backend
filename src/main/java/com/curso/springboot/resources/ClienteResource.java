...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> findByEmail(@RequestParam("value") String email) {
		...
		obj = this.service.findByEmail(email);
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		listaDTO = lista.stream().map(obj -> new ClienteDTO(obj)).collect(Collectors.toList());
	...
	public ResponseEntity<Page<ClienteDTO>> findAllPage(
		...
		Page<Cliente> lista = null;
		Page<ClienteDTO> listaDTO = null;
			
		lista = this.service.findPage(page, linesPorPage, orderBy, direction);
		
		listaDTO = lista.map(obj -> new ClienteDTO(obj));
